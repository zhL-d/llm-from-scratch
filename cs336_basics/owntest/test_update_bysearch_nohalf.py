...
@pytest.mark.parametrize("paircount_ctx, typ, pretoken,"
...
def test_update_bysearch_no_half(paircount_ctx, typ, pretoken, 
                               expected_new_pair_count):
    
    pair_counts_ctx = paircount_ctx

    pair_counts_ctx.update_bysearch_no_half(typ, pretoken)
