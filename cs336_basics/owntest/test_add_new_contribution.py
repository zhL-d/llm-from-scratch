...
from cs336_basics.train_bpe import _add_new_contribution
...
def test_build_new_pretoken(pretoken, pair_count, reversed_cache,
    ...
    updated_pair_count, updated_reversed_cache = _add_new_contribution(pretoken, pair_count, reversed_cache)
