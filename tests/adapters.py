...
def run_multihead_self_attention_with_rope(
    ...
    Returns:
        ...
        implementation with the given QKV projection weights and input features.
    """
    model = MultiHeadSelfAttentionRope(d_model, num_heads, max_seq_len, theta)
    model.load_state_dict(
        {
            "Q": q_proj_weight,
            "K": k_proj_weight,
    ...
    result = model.forward(in_features, token_positions)
    return result
    # raise NotImplementedError
...
def run_get_lr_cosine_schedule(
    ...
    """
    return LearningRateSchedule(it, max_learning_rate, min_learning_rate, warmup_iters, cosine_cycle_iters)
    # raise NotImplementedError
